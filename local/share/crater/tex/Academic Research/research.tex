...
\begin{titlepage}
	...
	\vspace{1cm}
	\begin{center}
		\includegraphics[width=3cm]{ucv.png}
	\end{center}
...
Este documento contiene varios ejemplos de código en C++. El propósito de este documento es demostrar cómo se pueden estructurar y utilizar diferentes características del lenguaje C++.
